...
export default function Carousel() {
  ...
  return (
    <>
      ...
      >
        <SwiperSlide className='testimonial-carousel-item-mobile'>
          <div className='testimonial-container-mobile'>
            <img className='student-image-mobile' src={P1} alt='aluno' />
            <span className='student-name-mobile'>Ana Silva</span>
        ...
        <SwiperSlide className='testimonial-carousel-item-mobile'>
          <div className='testimonial-container-mobile'>
            <img className='student-image-mobile' src={P2} alt='aluno' />
            <span className='student-name-mobile'>Carlos Santos</span>
            <p className='testimonial-description-mobile'>
        ...
        <SwiperSlide className='testimonial-carousel-item-mobile'>
          <div className='testimonial-container-mobile'>
            <img className='student-image-mobile' src={P3} alt='aluno' />
            <span className='student-name-mobile'>Maria Ferreira</span>
            <p className='testimonial-description-mobile'>
        ...
        <SwiperSlide className='testimonial-carousel-item-mobile'>
          <div className='testimonial-container-mobile'>
            <img className='student-image-mobile' src={P4} alt='aluno' />
            <span className='student-name-mobile'>Luísa Torres</span>
            <p className='testimonial-description-mobile'>
